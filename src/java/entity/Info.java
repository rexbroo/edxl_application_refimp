...
@NamedQueries({
    ...
    , @NamedQuery(name = "Info.findByInfo", query = "SELECT i FROM Info i WHERE i.infoPK.info = :info")
    ...
    , @NamedQuery(name = "Info.findByCategoryId", query = "SELECT i FROM Info i WHERE i.infoPK.categoryId = :categoryId")
...
public class Info implements Serializable {
    ...
    public Info(InfoPK infoPK, String alertIdentifier) {
        this.infoPK = infoPK;
        this.alertIdentifier = alertIdentifier;
    }

    public Info(String info, int categoryId) {
        this.infoPK = new InfoPK(info, categoryId);
    }
    ...
    public String toString() {
        return "entity.Info[ infoPK=" + infoPK + " ]";
    }
